...
# dfa = pd.DataFrame({'id': [900, 901, 902, 903, 904, 905, 906, 907, 908, 909, 910, 911, 912, 913, 914],
#                     'fT': ['dummy', 'dummy', 'dummy', 'dummy', 'dummy', 'dummy', 'dummy', 'dummy', 'dummy', 'dummy', 'dummy', 'dummy', 'dummy', 'dummy', 'dummy'],
#                     'sT': ['', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
#                     'x': [200, 400, 600, 800, 1000, 200, 400, 600, 800, 1000, 200, 400, 600, 800, 1000],
#                     'y': [900, 900, 900, 900, 900, 0, 0, 0, 0, 0, 1800, 1800, 1800, 1800, 1800],
#                     },
#                    )

dfa = pd.DataFrame({'id': [900, 901, 902, 903, 904, 905, 906, 907, 908, 909],
                    'fT': ['dummy', 'dummy', 'dummy', 'dummy', 'dummy', 'dummy', 'dummy', 'dummy', 'dummy', 'dummy'],
                    'sT': ['', '', '', '', '', '', '', '', '', ''],
                    'x': [200, 400, 600, 800, 1000, 200, 400, 600, 800, 1000],
                    'y': [0, 0, 0, 0, 0, 1800, 1800, 1800, 1800, 1800],
                    },
                   )
...
tf_br = df["fT"].str.contains("BR").to_list()
...
for i in range(len(df)):
    if tf_r[i]:
        ...
        df.iloc[i, 5] = np.random.randint(5, 8)
    else:
...
# bar graph code
x, y, z = df.iloc[:-10, 3], df.iloc[:-10, 4], df.iloc[:-10, 5]
# print(x, y, z)
top = z
...
plt.savefig("2walls_bigbr_jton_%s.png" % file)
