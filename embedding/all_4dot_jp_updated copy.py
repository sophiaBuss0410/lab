...
# Plotting
fig, axes = plt.subplots(3, 4, figsize=(16,16), subplot_kw={'projection': '3d'})
...
# plt.savefig('embedding/all_4dots_jp_updated.png', bbox_inches='tight', pad_inches=0.5)
plt.show()
